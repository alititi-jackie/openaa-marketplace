...
function toOpenMode(value: unknown): 'auto' | 'same' | 'new' | null | undefined {
  if (value === undefined) return undefined
...
export async function PATCH(
  ...
  const { title, url, description, open_mode, sort_order, is_active } = body as Record<string, unknown>
