...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[560px] z-50 bg-white/95 backdrop-blur-md border-t border-zinc-100/80 shadow-[0_-8px_24px_rgba(0,0,0,0.08)]">
      <div className="grid grid-cols-5 h-16 items-end pb-2">
        ...
        <div className="flex flex-col items-center justify-end pb-1">
          <Link href="/publish" className="flex flex-col items-center gap-0.5">
            <div className="-mt-7 w-[58px] h-[58px] rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-xl shadow-blue-500/40 border-[3px] border-white">
